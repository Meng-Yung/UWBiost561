...
date: "Due date: 7:00pm on Friday, June 13th, 2025"
output: 
...
For this project, you'll be making a PkgDown website that looks like [https://linnykos.github.io/561_s2025_example/](https://linnykos.github.io/561_s2025_example/). Briefly, this will involve:
...
- This is a text file that goes into the top-level of your `R` package. (It's in the same place as the `DESCRIPTION` and `NAMESPACE` files.) 
  - See [https://raw.githubusercontent.com/linnykos/561_s2025_example/main/README.md](https://raw.githubusercontent.com/linnykos/561_s2025_example/main/README.md) as an example
- This should include the URLs to 1) your GitHub package (i.e., the website to see the files for the R package) and 2) your PkgDown website. 
  - For example, the former is [https://github.com/linnykos/561_s2025_example](https://github.com/linnykos/561_s2025_example) while the latter is [https://linnykos.github.io/561_s2025_example/](https://linnykos.github.io/561_s2025_example/)
...
- A landing page (analogous to [https://linnykos.github.io/561_s2025_example/](https://linnykos.github.io/561_s2025_example/))
- A "Get started" (or similarly named) webpage (analogous to [https://linnykos.github.io/561_s2025_example/articles/UW561S2024Example.html](https://linnykos.github.io/561_s2025_example/articles/UW561S2024Example.html)). This is vignette that is generated based on the R Markdown file you include in the `vignettes` folder that is named after your R package (see [https://github.com/linnykos/561_s2025_example/blob/main/vignettes/UW561S2024Example.Rmd](https://github.com/linnykos/561_s2025_example/blob/main/vignettes/UW561S2024Example.Rmd))
- A "Reference" (or similarly named) webpage (analogous to [https://linnykos.github.io/561_s2025_example/reference/index.html](https://linnykos.github.io/561_s2025_example/reference/index.html)). These are created based on the all the ROxygen documentations you write for your functions in the `R` folder
...
Our class's Google Docs for additional notes on how to make your PkgDown is:
